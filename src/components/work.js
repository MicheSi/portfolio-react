    ...
    return (
        <section id='work'>
            ...
            <div className='projectDiv'>
                ...
                <div className='dream'>
                    <a href='https://github.com/MicheSi/my_dream_journal/' target='_blank' rel='noopener noreferrer'><img src={dream} alt='Dream Journal'/></a>
                ...
                <div className='border'></div>
                <div className='ddt'>
                    <a href='https://github.com/MicheSi/datadriventransit' target='_blank' rel='noopener noreferrer'><img src={ddt} alt='Data Driven Transit' /></a>
