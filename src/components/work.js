        ...
        <section id='work'>
            ...
            <div className='projectDiv'>
                ...
                <div className='gigapet'>
                    ...
                    <a href='https://gigapet-1.now.sh/' target='_blank' rel='noopener noreferrer'><h3>Gigapet</h3></a>
                ...
                <div className='farmfresh'>
                    ...
                    <a href='https://farmfresh.now.sh/' target='_blank' rel='noopener noreferrer'><h3>Farm Fresh Produce</h3></a>
                ...
                <div className='amiibo'>
                    ...
                    <a href='https://amiibo.now.sh/' target='_blank' rel='noopener noreferrer'><h3>Amiibo</h3></a>
